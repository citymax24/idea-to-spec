...
**Review coverage — closed by acceptance, not by coverage.** yana accepted v1.2 on 2026-09-05 without a section-by-section review pass, knowingly and after being shown the assumptions below.
...
**Design caught up with the spec.** SCR-08, its five state artboards and the clickable prototype were rebuilt against FR-029 and FR-031 to FR-033 on 2026-09-05: the administrator right per user, the count in the header, the refusal at the second-to-last administrator, and a setup step that names the second one. `design/brief.md` was regenerated from v1.2.
