...
|----|------|--------|-----------------------------|------------------------|--------|
| R[n]-01 | CHANGE | §2 | "[quote]" | [one precise sentence naming the IDs that change] | proposed |

## Notes

- [MISREAD items: what the spec said, and which source location it was read from]
- [Corrections the reviewer made during confirmation]
