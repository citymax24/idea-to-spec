# EAA5 · WCAG-2.1-Recommendation.html

- **Kind**: document
- **Converted**: 2026-09-05
- **Cite as**: EAA5 p.<n> or EAA5 §<heading>
...
[W3C Recommendation](https://www.w3.org/standards/types#REC) 06 May 2025
...
:   [Commit history](https://github.com/w3c/wcag/commits/WCAG-2.1)
...
:   public-agwg-comments@w3.org with subject line `[WCAG21] … message topic …` ([archives](https://lists.w3.org/Archives/Public/public-agwg-comments))

Errata:
:   [Errata exists](https://www.w3.org/WAI/WCAG21/errata/).

See also
[**translations**](https://www.w3.org/Translations/?technology=WCAG21).
...
This is a [Recommendation](https://www.w3.org/policies/process/20231103/#recs-and-notes) of WCAG 2.1 by the [Accessibility Guidelines Working Group](https://www.w3.org/WAI/GL/). This incorporates [errata](https://www.w3.org/WAI/WCAG21/errata/) and are described in the [change log](#changelog). At some point additional changes might be incorporated into an [Edited or Amended Recommendation](https://www.w3.org/policies/process/20231103/#revised-rec).

To comment, [file an issue in the W3C WCAG GitHub repository](https://github.com/w3c/wcag/issues/new). Although the proposed success criteria in this document reference issues tracking discussion, the Working Group requests that public comments be filed as new issues, one issue per discrete comment. It is free to create a GitHub account to file issues. If filing issues in GitHub is not feasible, send email to public-agwg-comments@w3.org ([comment archive](https://lists.w3.org/Archives/Public/public-agwg-comments/)).
...
3. [Introduction](#intro)
   ...
   3. [WCAG 2.1 Supporting Documents](#wcag-2-1-supporting-documents)
   4. [Requirements for WCAG 2.1](#requirements-for-wcag-2-1)
   5. [Comparison with WCAG 2.0](#comparison-with-wcag-2-0)
      1. [New Features in WCAG 2.1](#new-features-in-wcag-2-1)
      2. [Numbering in WCAG 2.1](#numbering-in-wcag-2-1)
      3. [Conformance to WCAG 2.1](#conformance-to-wcag-2-1)
...
5. [2. Operable](#operable)
   ...
   5. [2.5 Input Modalities](#input-modalities)
      ...
      5. [2.5.5 Target Size](#target-size)
...
See [Web Content Accessibility Guidelines (WCAG) Overview](https://www.w3.org/WAI/standards-guidelines/wcag/) for a description of the WCAG 2.1 supporting material, including education resources related to WCAG 2. Additional resources covering topics such as the business case for web accessibility, planning implementation to improve the accessibility of websites, and accessibility policies are listed in [WAI Resources](https://www.w3.org/WAI/Resources/Overview).
...
[Understanding Text Alternatives](https://www.w3.org/WAI/WCAG21/Understanding/text-alternatives.html) |
[How to Meet Text Alternatives](https://www.w3.org/WAI/WCAG21/quickref/#text-alternatives)
...
[Understanding Time-based Media](https://www.w3.org/WAI/WCAG21/Understanding/time-based-media.html) |
[How to Meet Time-based Media](https://www.w3.org/WAI/WCAG21/quickref/#time-based-media)
...
[Understanding Adaptable](https://www.w3.org/WAI/WCAG21/Understanding/adaptable.html) |
[How to Meet Adaptable](https://www.w3.org/WAI/WCAG21/quickref/#adaptable)
...
[Understanding Distinguishable](https://www.w3.org/WAI/WCAG21/Understanding/distinguishable.html) |
[How to Meet Distinguishable](https://www.w3.org/WAI/WCAG21/quickref/#distinguishable)
...
[Understanding Keyboard Accessible](https://www.w3.org/WAI/WCAG21/Understanding/keyboard-accessible.html) |
[How to Meet Keyboard Accessible](https://www.w3.org/WAI/WCAG21/quickref/#keyboard-accessible)
...
[Understanding Enough Time](https://www.w3.org/WAI/WCAG21/Understanding/enough-time.html) |
[How to Meet Enough Time](https://www.w3.org/WAI/WCAG21/quickref/#enough-time)
...
[Understanding Seizures and Physical Reactions](https://www.w3.org/WAI/WCAG21/Understanding/seizures-and-physical-reactions.html) |
[How to Meet Seizures and Physical Reactions](https://www.w3.org/WAI/WCAG21/quickref/#seizures-and-physical-reactions)
...
[Understanding Navigable](https://www.w3.org/WAI/WCAG21/Understanding/navigable.html) |
[How to Meet Navigable](https://www.w3.org/WAI/WCAG21/quickref/#navigable)
...
[Understanding Input Modalities](https://www.w3.org/WAI/WCAG21/Understanding/input-modalities.html) |
[How to Meet Input Modalities](https://www.w3.org/WAI/WCAG21/quickref/#input-modalities)
...
Essential
:   A particular presentation of the target is [essential](#dfn-essential "if removed, would fundamentally change the information or functionality of the content, and information and functionality cannot be achieved in another way that would conform") to the information being conveyed.
...
[Understanding Readable](https://www.w3.org/WAI/WCAG21/Understanding/readable.html) |
[How to Meet Readable](https://www.w3.org/WAI/WCAG21/quickref/#readable)
...
[Understanding Predictable](https://www.w3.org/WAI/WCAG21/Understanding/predictable.html) |
[How to Meet Predictable](https://www.w3.org/WAI/WCAG21/quickref/#predictable)
...
[Understanding Input Assistance](https://www.w3.org/WAI/WCAG21/Understanding/input-assistance.html) |
[How to Meet Input Assistance](https://www.w3.org/WAI/WCAG21/quickref/#input-assistance)
...
[Understanding Compatible](https://www.w3.org/WAI/WCAG21/Understanding/compatible.html) |
[How to Meet Compatible](https://www.w3.org/WAI/WCAG21/quickref/#compatible)
...
Since this criterion was written, the HTML Living Standard has adopted specific requirements governing how user agents must handle incomplete tags, incorrect element nesting, duplicate attributes, and non-unique IDs. [[HTML](#bib-html "HTML Standard")]
...
This section lists requirements for [conformance](#dfn-conform "satisfying all the requirements of a given standard, guideline or specification") to WCAG 2.1. It also gives information about how to make conformance claims, which are optional. Finally, it describes what it means to be [accessibility supported](#dfn-accessibility-supported "supported by users' assistive technologies as well as the accessibility features in browsers and other user agents"), since only accessibility-supported ways of using technologies can be [relied upon](#dfn-relied-upon "the content would not conform if that technology is turned off or is not supported") for conformance. [Understanding Conformance](https://www.w3.org/WAI/WCAG21/Understanding/conformance) includes further explanation of the accessibility-supported concept.

### 5.1 Interpreting Normative Requirements

The main content of WCAG 2.1 is [normative](#dfn-normative "required for conformance") and defines requirements that impact conformance claims. Introductory material, appendices, sections marked as "non-normative", diagrams, examples, and notes are [informative](#dfn-informative "for information purposes and not required for conformance") (non-normative). Non-normative material provides advisory information to help interpret the guidelines but does not create requirements that impact a conformance claim.
...
For more information, including examples, see [Understanding Conformance Requirements](https://www.w3.org/WAI/WCAG21/Understanding/conformance#conformance-requirements).
...
1. **Date** of the claim
2. **Guidelines title, version and URI**  "Web Content Accessibility Guidelines 2.1 at <https://www.w3.org/TR/WCAG21/>"
...
5. A list of the **[web content technologies](#dfn-technologies "mechanism for encoding instructions to be rendered, played or executed by user agents")
...
Refer to [Understanding Conformance Claims](https://www.w3.org/WAI/WCAG21/Understanding/conformance#conformance-claims) for more information and example conformance claims.

Note 2

Refer to [Understanding Metadata](https://www.w3.org/WAI/WCAG21/Understanding/understanding-metadata) for more information about the use of metadata in conformance claims.
...
:   the relative brightness of any point in a colorspace, normalized to 0 for darkest
    ...
    * BsRGB = B8bit/255
    ...
    authors should evaluate using sRGB colorspace. If using other color spaces, see [Understanding Success Criterion 1.4.3](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum).
...
This section shows changes for WCAG 2.1 since its publication as a W3C Recommendation. These changes are also recorded as [errata](https://www.w3.org/WAI/WCAG21/errata/).

Changes since the [W3C Recommendation of 12 December 2024](https://www.w3.org/TR/2024/REC-WCAG21-20241212/):

* Updated content to fully reflect the changes listed under "Changes since the W3C Recommendation of 21 September 2023";
  in the previous publication, out of the items listed under that heading, only the item related to input purposes was actually reflected in content
* Removed the change log entry regarding visual presentation for content identified as New,
  which was not reviewed in the context of WCAG 2.1
* Modified the definitions of [single pointer](#dfn-single-pointer "an input modality that only targets a single point on the page/screen at a time – such as a mouse, single finger on a touch screen, or stylus."), [used in an unusual or restricted way](#dfn-used-in-an-unusual-or-restricted-way "words used in such a way that requires users to know exactly which definition to apply in order to understand the content correctly"), and [programmatically determined link context](#dfn-programmatically-determined-link-context "additional information that can be programmatically determined from relationships with a link, combined with the link text, and presented to users in different modalities")
* Reverted a change to the definition of [pointer input](#dfn-pointer-inputs "input from a device that can target a specific coordinate (or set of coordinates) on a screen, such as a mouse, pen, or touch contact") which had been intended for [single pointer](#dfn-single-pointer "an input modality that only targets a single point on the page/screen at a time – such as a mouse, single finger on a touch screen, or stylus.")

Changes since the [W3C Recommendation of 21 September 2023](https://www.w3.org/TR/2023/REC-WCAG21-20230921/):

* Modified the formatting of definitions for [changes of context](#dfn-change-of-context "major changes that, if made without user awareness, can disorient users who are not able to view the entire page simultaneously"), [general flash and red flash thresholds](#dfn-general-flash-and-red-flash-thresholds "a flash or rapidly changing image sequence is below the threshold (i.e., content passes) if any of the following are true:"), and [structure](#dfn-structure "The way the parts of a web page are organized in relation to each other; and The way a collection of web pages is organized")
...
Changes since the [W3C Recommendation of 05 June 2018](https://www.w3.org/TR/2018/REC-WCAG21-20180605/):

* In the [Status of This Document](https://www.w3.org/TR/WCAG21/#sotd) the paragraph beginning "This document has been reviewed by W3C Members..." appears twice. The first instance of this paragraph has been removed.
* In the [Introduction](https://www.w3.org/TR/WCAG21/#intro), several (but not all) references to "WCAG 2.0" has been changed to "WCAG 2.1".
* In the [0.5.2 Numbering in WCAG 2.1](https://www.w3.org/TR/WCAG21/#numbering-in-wcag-2-1), the words "critera" and "ccriteria" have been changed to "criteria".
* In [1.4.10 Reflow](https://www.w3.org/TR/WCAG21/#reflow), the first note had a supernumary "Note" indicator which has been removed.
* In [1.4.13 Content on Hover or Focus](https://www.w3.org/TR/WCAG21/#content-on-hover-or-focus), the word "dismissable" has been changed to "dismissible".
* In [4. Robust](https://www.w3.org/TR/WCAG21/#robust), repetition of the word "by" has been removed.
* In [5.2.2 Full pages](https://www.w3.org/TR/WCAG21/#cc2), the third note began with "New" which has been removed.
* In [5.3.1 Required Components of a Conformance Claim](https://www.w3.org/TR/WCAG21/#conformance-required) the editorial note "In WCAG 2.0 this was a dated URI, which may need to be adjusted when this becomes a Rec." has been removed.
* In the definition for [keyboard interface](https://www.w3.org/TR/WCAG21/#dfn-keyboard-interface), the second (of three) note has been changed to be an example of the first note, leaving only two actual notes.
* In the definition for [technology](https://www.w3.org/TR/WCAG21/#dfn-technologies), the third note has been changed to be an example.
* In [7. Input Purposes for User Interface Components](https://www.w3.org/TR/WCAG21/#input-purposes), the word "county" has been changed to "country".
...
* In [a note in the definition of accessibility supported](https://www.w3.org/TR/WCAG21/#issue-container-generatedID-43), references to "Conformance Criterion" were changed to "Conformance Requirement".
* In the [definition of relative luminance](https://www.w3.org/TR/WCAG21/#dfn-relative-luminance), the red threshold was updated from 0.03928 to 0.04045.
* In [4.1.1 Parsing](https://www.w3.org/TR/WCAG21/#parsing) one note was deleted, and two notes were added, including: "This Success Criterion should be considered as always satisfied for any content using HTML or XML."

The full [commit history to WCAG 2.1](https://github.com/w3c/wcag/commits/WCAG-2.1/guidelines) is available.
...
This publication has been funded in part with U.S. Federal funds from the Health and Human Services, National Institute on Disability, Independent Living, and Rehabilitation Research (NIDILRR), under contract number HHS75P00120P00168 (previously ED-OSE-10-C-0067 and HHSP23301500054C). The content of this publication does not necessarily reflect the views or policies of the U.S. Department of Health and Human Services or the U.S. Department of Education, nor does mention of trade names, commercial products, or organizations imply endorsement by the U.S. Government.
...
[css3-values]
:   [CSS Values and Units Module Level 3](https://www.w3.org/TR/css-values-3/). Tab Atkins Jr.; Elika Etemad. W3C. 22 March 2024. CRD. URL: <https://www.w3.org/TR/css-values-3/>
...
[UNESCO]
:   [International Standard Classification of Education](https://uis.unesco.org/en/files/international-standard-classification-education-1997-en-pdf). 1997. URL: <https://uis.unesco.org/en/files/international-standard-classification-education-1997-en-pdf>

[WAI-WEBCONTENT]
:   [Web Content Accessibility Guidelines 1.0](https://www.w3.org/TR/WAI-WEBCONTENT/). Wendy Chisholm; Gregg Vanderheiden; Ian Jacobs. W3C. 5 May 1999. W3C Proposed Recommendation. URL: <https://www.w3.org/TR/WAI-WEBCONTENT/>
...
* [§ 6. Glossary](#ref-for-dfn-content-1 "§ 6. Glossary") [(2)](#ref-for-dfn-content-2 "Reference 2") [(3)](#ref-for-dfn-content-3 "Reference 3") [(4)](#ref-for-dfn-content-4 "Reference 4")
...
* [§ 2.5.5 Target Size](#ref-for-dfn-css-pixels-3 "§ 2.5.5 Target Size")
...
* [§ 2.5.5 Target Size](#ref-for-dfn-essential-12 "§ 2.5.5 Target Size")
...
* [§ 6. Glossary](#ref-for-dfn-functionality-6 "§ 6. Glossary")
...
* [§ 3.3.4 Error Prevention (Legal, Financial, Data)](#ref-for-dfn-mechanism-13 "§ 3.3.4 Error Prevention (Legal, Financial, Data)")
* [§ 3.3.6 Error Prevention (All)](#ref-for-dfn-mechanism-14 "§ 3.3.6 Error Prevention (All)")
* [§ 6. Glossary](#ref-for-dfn-mechanism-15 "§ 6. Glossary") [(2)](#ref-for-dfn-mechanism-16 "Reference 2")
...
* [§ 6. Glossary](#ref-for-dfn-non-text-content-2 "§ 6. Glossary")
...
* [§ 2.5.5 Target Size](#ref-for-dfn-pointer-inputs-1 "§ 2.5.5 Target Size")
* [§ A. Change Log](#ref-for-dfn-pointer-inputs-2 "§ A. Change Log")
...
* [§ 6. Glossary](#ref-for-dfn-presentation-3 "§ 6. Glossary")
...
* [§ 5.2.3 Complete processes](#ref-for-dfn-processes-2 "§ 5.2.3 Complete processes")
* [§ 6. Glossary](#ref-for-dfn-processes-3 "§ 6. Glossary") [(2)](#ref-for-dfn-processes-4 "Reference 2") [(3)](#ref-for-dfn-processes-5 "Reference 3") [(4)](#ref-for-dfn-processes-6 "Reference 4")
...
* [§ A. Change Log](#ref-for-dfn-programmatically-determined-link-context-2 "§ A. Change Log")
...
* [§ A. Change Log](#ref-for-dfn-single-pointer-3 "§ A. Change Log") [(2)](#ref-for-dfn-single-pointer-4 "Reference 2")
...
* [§ 2.5.5 Target Size](#ref-for-dfn-targets-1 "§ 2.5.5 Target Size")

[Permalink](#dfn-technologies)

**Referenced in:**

* [§ 5.2.4 Only Accessibility-Supported Ways of Using Technologies](#ref-for-dfn-technologies-1 "§ 5.2.4 Only Accessibility-Supported Ways of Using Technologies")
* [§ 5.2.5 Non-Interference](#ref-for-dfn-technologies-2 "§ 5.2.5 Non-Interference")
* [§ 5.3.1 Required Components of a Conformance Claim](#ref-for-dfn-technologies-3 "§ 5.3.1 Required Components of a Conformance Claim")
* [§ 6. Glossary](#ref-for-dfn-technologies-4 "§ 6. Glossary") [(2)](#ref-for-dfn-technologies-5 "Reference 2") [(3)](#ref-for-dfn-technologies-6 "Reference 3")
...
* [§ 4.1.2 Name, Role, Value](#ref-for-dfn-user-agents-3 "§ 4.1.2 Name, Role, Value")
* [§ 6. Glossary](#ref-for-dfn-user-agents-4 "§ 6. Glossary") [(2)](#ref-for-dfn-user-agents-5 "Reference 2") [(3)](#ref-for-dfn-user-agents-6 "Reference 3") [(4)](#ref-for-dfn-user-agents-7 "Reference 4") [(5)](#ref-for-dfn-user-agents-8 "Reference 5") [(6)](#ref-for-dfn-user-agents-9 "Reference 6") [(7)](#ref-for-dfn-user-agents-10 "Reference 7") [(8)](#ref-for-dfn-user-agents-11 "Reference 8") [(9)](#ref-for-dfn-user-agents-12 "Reference 9") [(10)](#ref-for-dfn-user-agents-13 "Reference 10")
...
* [§ 2.5.3 Label in Name](#ref-for-dfn-user-interface-components-7 "§ 2.5.3 Label in Name")
* [§ 2.5.4 Motion Actuation](#ref-for-dfn-user-interface-components-8 "§ 2.5.4 Motion Actuation")
* [§ 3.2.1 On Focus](#ref-for-dfn-user-interface-components-9 "§ 3.2.1 On Focus")
* [§ 3.2.2 On Input](#ref-for-dfn-user-interface-components-10 "§ 3.2.2 On Input")
* [§ 4.1.2 Name, Role, Value](#ref-for-dfn-user-interface-components-11 "§ 4.1.2 Name, Role, Value")
* [§ 6. Glossary](#ref-for-dfn-user-interface-components-12 "§ 6. Glossary") [(2)](#ref-for-dfn-user-interface-components-13 "Reference 2")
* [§ 7. Input Purposes for User Interface Components](#ref-for-dfn-user-interface-components-14 "§ 7. Input Purposes for User Interface Components")
...
* [§ 3.3.4 Error Prevention (Legal, Financial, Data)](#ref-for-dfn-web-page-s-9 "§ 3.3.4 Error Prevention (Legal, Financial, Data)")
* [§ 3.3.6 Error Prevention (All)](#ref-for-dfn-web-page-s-10 "§ 3.3.6 Error Prevention (All)")
* [§ 5.2.1 Conformance Level](#ref-for-dfn-web-page-s-11 "§ 5.2.1 Conformance Level")
* [§ 5.2.2 Full pages](#ref-for-dfn-web-page-s-12 "§ 5.2.2 Full pages")
* [§ 5.2.3 Complete processes](#ref-for-dfn-web-page-s-13 "§ 5.2.3 Complete processes")
* [§ 5.2.5 Non-Interference](#ref-for-dfn-web-page-s-14 "§ 5.2.5 Non-Interference")
* [§ 5.3 Conformance Claims (Optional)](#ref-for-dfn-web-page-s-15 "§ 5.3 Conformance Claims (Optional)")
* [§ 6. Glossary](#ref-for-dfn-web-page-s-16 "§ 6. Glossary") [(2)](#ref-for-dfn-web-page-s-17 "Reference 2") [(3)](#ref-for-dfn-web-page-s-18 "Reference 3") [(4)](#ref-for-dfn-web-page-s-19 "Reference 4") [(5)](#ref-for-dfn-web-page-s-20 "Reference 5") [(6)](#ref-for-dfn-web-page-s-21 "Reference 6")
